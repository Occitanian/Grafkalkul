...
В файле [scriptsInEvents.js](https://github.com/Occitanian/Grafkalkul/blob/main/scripts/project/scriptsInEvents.js) содержится полный модуль ray marching, включающий:
