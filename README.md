...
В файле [`[scripts/scriptsInEvents.js](https://github.com/Occitanian/Grafkalkul/blob/main/scripts/project/scriptsInEvents.js)`](scripts/scriptsInEvents.js) содержится полный модуль ray marching, включающий:
